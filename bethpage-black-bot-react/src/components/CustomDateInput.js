...
export default function CustomDateInput({
    ...
    setFormData,
    onErrorsChange,
    field = 'extra_playable_days',
    heading = 'Extra Playable Days',
    description = "What additional days could you play? (past dates will be automatically removed when you save)",
}) {
    const dates = (formData?.[field] || ['']).map(d => {
        if (d.includes('/')) {
    ...
    const updateDate = (index, value) => {
        ...
        setFormData(prev => ({ ...prev, [field]: newDates }));
